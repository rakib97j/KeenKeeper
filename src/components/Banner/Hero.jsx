    ...
    return (
      <div className="md:py-20 py-10 md:px-0 px-3 container mx-auto ">
        ...
        <div className=" text-center">
          ...
          <button className="btn bg-[#244D3F] border-0 mb-10">
            {" "}
            <Plus /> Add a Friend
          </button>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-10">
            <div className="bg-white p-8 rounded-xl shadow-lg border-0">
              ...
              <h1 className="text-[#64748B] text-xl font-medium mt-2 ">Total Friends</h1>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-0">
              <h1  className='text-[#244D3F] font-semibold text-4xl' >3</h1>
              <h1 className="text-[#64748B] text-xl font-medium mt-2 ">On Track</h1>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-0">
              <h1  className='text-[#244D3F] font-semibold text-4xl' >6</h1>
              <h1 className="text-[#64748B] text-xl font-medium mt-2 ">Need Attention</h1>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-0">
              <h1  className='text-[#244D3F] font-semibold text-4xl' >12</h1>
              <h1 className="text-[#64748B] text-xl font-medium mt-2 ">Interactions This Month</h1>
            </div>
          </div>
